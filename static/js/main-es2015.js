...
let CareersService = class CareersService {
    ...
    getCareers() {
        ...
        return this.http.get(this.careersUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.unit.log('Career Serv :: Careers Gotten')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getCareers', [])));
    }
    getCareer(id) {
        this.unit.log("Career Serv :: CarrerID Began :: " + id);
        return this.http.post(this.careerUrl, { id: id }, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.unit.log('Career Serv :: CareerID Gotten')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getCareer', null)));
    }
    getCurCareer() {
    ...
    getSpecialization(id) {
        ...
        if (this.curCareerId > 0) {
            return this.http.post(this.specializationUrl, { id: id }, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.unit.log('Career Serv :: Specialization Id Gotten')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getSpecialization', null)));
        }
        return null;
    }
    getSpecTalents(id) {
    ...
    getTalent(id) {
        ...
        if (this.curSpecId > 0) {
            return this.http.post(this.talentUrl, { id: id }, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.unit.log('Career Serv :: Talent Id Gotten')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getTalent', null)));
        }
        return null;
    }
...
let SpeciesService = class SpeciesService {
    ...
    getSpecies() { return this.obsSpecies; }
    fetchSpecies() {
        this.unit.log("Spec Serv :: Species Began");
        this.http.get(this.speciesUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.unit.log('Spec Serv :: Species Gotten')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getSpecies', [])))
            .subscribe(specs => {
